...
class Ui_DialogAnalog(object):
    def setupUi(self, DialogAnalog):
        ...
        self.pushButtonNoRT = QtWidgets.QPushButton(DialogAnalog)
        font = QtGui.QFont()
        font.setFamily("Gill Sans")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.tableViewRTS_plot_window.setMaximumSize(QtCore.QSize(1200, 16777215))
        font = QtGui.QFont()
        font.setFamily("Gill Sans")
        ...
        self.gridLayout.addWidget(self.tableViewRTS_plot_window, 0, 2, 3, 1)
